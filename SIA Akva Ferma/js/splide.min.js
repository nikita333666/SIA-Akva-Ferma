...
!function(e) {
    ...
    function Q(h, o) {
        var t, i = h.root, r = h.classes, p = [];
        i.id || (window.splide = window.splide || {},
        ...
        var s = {
            ...
            init: function() {
                ...
                !function() {
                    ...
                    N(s.track && s.list, "Track or list was not found."),
                    s.slides = d(s.list, r.slide);
                    var t = a(r.arrows);
                    s.arrows = {
                        prev: c(t, "." + r.prev),
                        next: c(t, "." + r.next)
    ...
    function $(r, s) {
        var i, n, o, e = r.options.direction === it, a = r.is(H), u = r.options.direction === et, c = !1, d = u ? 1 : -1, l = {
            sign: d,
            mount: function() {
                n = s.Elements,
                i = s.Layout,
    ...
    function tt(o, t) {
        ...
        function r() {
            ...
            return i && (n = Math.ceil(u.track["client" + e] / i)),
